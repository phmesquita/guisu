...
class WindowClass(wx.Dialog):
    ...
    def basic_gui(self):
        ...
        self.lbl1=wx.StaticText(self.panel, pos=(10,25), label='Command:', size=(100,30))
        ...
        self.lbl2=wx.StaticText(self.panel, pos=(10,80), label='Parameters:', size=(100,30))
        ...
        self.lbl2=wx.StaticText(self.panel, pos=(10,135), label='Command:', size=(100,30))
                
        btn1 = wx.Button(self.panel, pos=(550,280), label='Run', size=(60,30))
        
        btn8 = wx.Button(self.panel, pos=(610,280), label='Clear', size=(50,30))
        ...
        self.lbl5=wx.StaticText(self.panel, pos=(10,180), label='Parameters:', size=(100,30))
        
        self.parametros2=wx.TextCtrl(self.panel, pos=(100,170),size=(100,30))
                
        self.lbl5=wx.StaticText(self.panel, pos=(10,270), label='Command    Line:', size=(100,60))
        
        self.linha=wx.TextCtrl(self.panel, pos=(100,280),size=(445,30))
                
        self.lbl4=wx.StaticText(self.panel, pos=(355,135), label='File:', size=(100,60))
        
        self.caminho=wx.TextCtrl(self.panel, pos=(415,125),size=(130,30))
        
        btn2 = wx.Button(self.panel, pos=(550,125), label='Search', size=(100,27))
        
        
                
        self.lbl5=wx.StaticText(self.panel, pos=(355,230), label='File:', size=(100,60))
        
        self.caminho2=wx.TextCtrl(self.panel, pos=(415,220),size=(130,30))
        
        btn3 = wx.Button(self.panel, pos=(550,220), label='Search', size=(100,27))
        
        
        
        
        self.lbl6=wx.StaticText(self.panel, pos=(355,20), label='File:', size=(100,60))
        
        self.caminho3=wx.TextCtrl(self.panel, pos=(415,10),size=(130,30))
        
        btn4 = wx.Button(self.panel, pos=(550,10), label='Search', size=(100,27))
        ...
        self.SetTitle('Graphic Interface - Seismic Unix')
        
    
    def onfile1(self, event):   
    
        wildcard = "All Files (*.*)|*.*" 
        dlg = wx.FileDialog(self, "Choose the file", os.getcwd(), "", wildcard, wx.FD_OPEN)
